...
const Sidebar = () => {
	...
	return (
		<aside
			className={`fixed top-[--dz-header-height] h-[calc(100vh-4.5rem)] z-[50] bg-sidebar-bg border-r-[1px] border-[--border] transition-all duration-300 shadow-[0rem_0.9375rem_1.875rem_0rem_rgba(0,0,0,0.1)] flex flex-col
        ${
			isMobileView
				? isMobileOpen
					? 'w-sidebar-wide'
